 ...
 */
public class ViewChannelDoctor extends javax.swing.JFrame {
    ...
    public ViewChannelDoctor() {
        initComponents();
    }
    public ViewChannelDoctor(String uname,int logid) {
        initComponents();
        username=uname;
        this.logid=logid;
  ...
  public void channelShow()
    {
      ArrayList<ChannelDTO> al;
        try {
           al = ChannelDao.channelListDoctor(logid);
////            for(PatientDTO k:al)
////         {
...
////         }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int index=channeltable.getSelectedRow();
         String channel_no=df.getValueAt(index,0).toString();
         String doc_name=df.getValueAt(index,1).toString();
        Prescription vp=new Prescription(channel_no,doc_name,username,logid);
        vp.setVisible(true);
        this.dispose();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        DoctorDashboard d=new DoctorDashboard(username,logid);
        d.setEnabled(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewChannelDoctor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewChannelDoctor().setVisible(true);
            }
        });
    }
